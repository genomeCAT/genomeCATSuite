 ...
 * PARTICULAR PURPOSE.
 */
public interface IFeature extends Region {
     ...
     */
    public static final Comparator<IFeature> comRatio = new Comparator<IFeature>() {

        public int compare(IFeature r1, IFeature r2) {
