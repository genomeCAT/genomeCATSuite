...
public class FeatureWithSpot extends FeatureImpl {
    ...
    public List<? extends Spot> spots = null;
    ...
    /**
     *Add the spot to the vector spots,
     *increment the size
     *point spots to this Feature/BAC
    ...
    /**
     *Calculate and set the ratio, variance, std
     *after the a spot is added to the vector spots,
     * ratios and variance are formated to 3 decimal places
     **/
