 ...
 * * @author Wei Chen * Email: wei@molgen.mpg.de * This program is developed
 * based on the algorithm by William S. Cleveland * This program is free
...
/**
 * Class LowessAlgoritm is a class implementing the Lowess Algorithm.Lowess
 * requires that the arrays x and y, which are the horizontal and vertical
 * coordinates respectively,of the scatterplot, be such that x is sorted from
...
public class LowessAlgorithm {
     ...
     * @delta Nonnegative parameter to save the computation. If delta>0, the
     * smoothing value will be calculated for the sequences, x[1],
     * x[delta+1],x[2*delta+1]...
