...
@ActionID(id = "org.molgen.genomeCATPro.guimodul.platform.ConvertPlatformAction", category = "DATA")
@ActionRegistration(displayName = "#CTL_ConvertPlatformAction", lazy = false)
@ActionReference(path = "Menu/Experiment/Platform", position = 200)
