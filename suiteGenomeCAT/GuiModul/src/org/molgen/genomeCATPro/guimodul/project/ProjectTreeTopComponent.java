...
/**
 * 310716 kt    persistence.never
 * 
 * Top component which displays project tree 
 */
@TopComponent.Description(
        preferredID = "ProjectTreeTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "explorer", openAtStartup = true)
@ActionID(category = "Window", id = "org.molgen.genomeCATPro.guimodul.project.ProjectTreeTopComponent")
...
private void cbSampleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSampleActionPerformed
    ...
    /**
     * Obtain the ProjectTreeTopComponent instance. Never call
