...
public class GlobalPositionDataPanel extends javax.swing.JPanel {

    String szCurrPosition = "";
    String szRelease = "";
    String szDetailPos = "";
    String szDetailInfo = "";
    private static GlobalPositionDataPanel instance = null;
    static private PropertyChangeSupport changeSupport;

    /** Creates new form GlobalPositionPanel */
    GlobalPositionDataPanel() {
        GlobalPositionDataPanel.changeSupport = new PropertyChangeSupport(this);
        initComponents();


    }

    public static GlobalPositionDataPanel getGlobalPositionDataPanel() {
        if (instance == null) {
    ...
    private void initComponents() {
        ...
        jLabelPosition.setFont(new java.awt.Font("Dialog", 1, 10));
