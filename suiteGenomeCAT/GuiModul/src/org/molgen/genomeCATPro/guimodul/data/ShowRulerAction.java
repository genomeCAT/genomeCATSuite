...
@ActionID(id = "org.molgen.genomeCATPro.guimodul.data.ShowRulerAction", category = "DATA")
@ActionRegistration(displayName = "show ruler", lazy = false)
@ActionReference(path = "Toolbars/globalmenu2", position = 3)
